...
typedef struct Baselib_Socket_Handle {
    intptr_t handle;
...
BASELIB_API Baselib_Socket_Handle
...
static inline Baselib_Socket_PollFd
Baselib_Socket_PollFd_New(Baselib_Socket_Handle handle, Baselib_Socket_PollEvents events,
                          Baselib_ErrorState *errorState) {
