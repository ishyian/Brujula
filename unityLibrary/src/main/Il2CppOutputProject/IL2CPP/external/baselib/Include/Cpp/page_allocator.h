...
namespace baselib {
    ...
    class page_allocator {
        static_assert((default_alignment
        != 0), "'default_alignment' must not be zero");

        static_assert(::baselib::Algorithm::IsPowerOfTwo(default_alignment),

        "'default_alignment' must be a power of two value");
    ...
    public:
        ...
        page_allocator(size_t page_size) : m_Impl(page_size) {
            ...
            BaselibAssert(::baselib::Algorithm::IsPowerOfTwo(page_size),
                          "'page_size' must be a power of two value");
        }
        ...
        void *reallocate(void *ptr, size_t old_size, size_t new_size,
                         error_state *error_state_ptr = nullptr) const {
            if (error_state_ptr)
        ...
        //
        // \returns True if the operation was successful.
        bool set_page_state(void *ptr, size_t size, Memory_PageState state,
                            error_state *error_state_ptr) const {
