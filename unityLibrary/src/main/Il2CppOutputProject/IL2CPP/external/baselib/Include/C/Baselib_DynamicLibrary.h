...
typedef struct Baselib_DynamicLibrary_Handle {
    intptr_t handle;
...
BASELIB_API Baselib_DynamicLibrary_Handle
...
Baselib_DynamicLibrary_OpenUtf16(
...
// - Baselib_ErrorCode_NotSupported: This feature is not supported on the current platform.
BASELIB_API Baselib_DynamicLibrary_Handle
Baselib_DynamicLibrary_OpenProgramHandle(
        Baselib_ErrorState
* errorState
);
...
BASELIB_API Baselib_DynamicLibrary_Handle
Baselib_DynamicLibrary_FromNativeHandle(
        uint64_t
handle,
uint32_t type,
        Baselib_ErrorState
