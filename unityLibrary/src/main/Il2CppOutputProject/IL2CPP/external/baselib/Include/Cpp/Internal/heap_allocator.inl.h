...
namespace baselib {
    ...
    namespace detail {
        ...
        class heap_allocator {
            ...
            struct MinAlignedImpl {
                ...
                static void *reallocate(void *ptr, size_t old_size, size_t new_size,
                                        Baselib_ErrorState *error_state_ptr) {
                    UNUSED(error_state_ptr);
                    UNUSED(old_size);
                ...
                static bool
                deallocate(void *ptr, size_t size, Baselib_ErrorState *error_state_ptr) {
                    UNUSED(error_state_ptr);
                    UNUSED(size);
        ...
        public:
            ...
            max_alignment = Baselib_Memory_MaxAlignment;
            ...
            using Impl = typename std::conditional<(alignment >
                                                    Baselib_Memory_MinGuaranteedAlignment), AlignedImpl, MinAlignedImpl>::type;
