...
namespace baselib {
    ...
    namespace detail {
        ...
        struct page_allocator_impl_test {
            static Baselib_Memory_PageAllocation
            Baselib_Memory_AllocatePages(uint64_t pageSize, uint64_t pageCount,
                                         uint64_t alignmentInMultipleOfPageSize,
                                         Baselib_Memory_PageState pageState,
                                         Baselib_ErrorState *errorState);

            static void Baselib_Memory_ReleasePages(Baselib_Memory_PageAllocation pageAllocation,
                                                    Baselib_ErrorState *errorState);

            static void Baselib_Memory_SetPageState(void *addressOfFirstPage, uint64_t pageSize,
                                                    uint64_t pageCount,
                                                    Baselib_Memory_PageState pageState,
                                                    Baselib_ErrorState *errorState);
        };
        ...
        typedef enum Memory_PageState : int {
            ...
            Memory_PageState_ReadOnly_Executable =
            Baselib_Memory_PageState_ReadOnly_Executable | Baselib_Memory_PageState_ReadOnly,
            Memory_PageState_ReadWrite_Executable =
            Baselib_Memory_PageState_ReadWrite_Executable | Baselib_Memory_PageState_ReadWrite,
        } Memory_PageState;
        ...
        class page_allocator {
            ...
            size_t PagedCountFromSize(size_t size) const {
        ...
        public:
            ...
            page_allocator(size_t page_size) : m_PageSize(page_size), m_PageSizeAligned(
                    page_size > alignment ? page_size : alignment) {}

            void *allocate(size_t size, int state, Baselib_ErrorState *error_state_ptr) const {
                Baselib_Memory_PageAllocation pa = Impl::Baselib_Memory_AllocatePages(m_PageSize,
                                                                                      PagedCountFromSize(
                                                                                              size),
                                                                                      m_PageSizeAligned /
                                                                                      m_PageSize,
                                                                                      (Baselib_Memory_PageState) state,
                                                                                      error_state_ptr);
                return pa.ptr;
            }

            bool deallocate(void *ptr, size_t size, Baselib_ErrorState *error_state_ptr) const {
                Impl::Baselib_Memory_ReleasePages({ptr, m_PageSize, PagedCountFromSize(size)},
                                                  error_state_ptr);
            ...
            bool set_page_state(void *ptr, size_t size, int state,
                                Baselib_ErrorState *error_state_ptr) const {
                Impl::Baselib_Memory_SetPageState(ptr, m_PageSize, PagedCountFromSize(size),
                                                  (Baselib_Memory_PageState) state,
                                                  error_state_ptr);
                return (error_state_ptr->code == Baselib_ErrorCode_Success);
            }
