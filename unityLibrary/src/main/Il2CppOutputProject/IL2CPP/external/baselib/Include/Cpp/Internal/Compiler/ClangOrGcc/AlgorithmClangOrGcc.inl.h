...
#else
            return (value & 0xffffffff00000000ULL) ? (63 - __builtin_clz((uint32_t)(value >> 32)))
                                                   : (31 - __builtin_clz((uint32_t) value));
#endif
        }
...
#else
            return (value & 0x00000000ffffffffULL) ? __builtin_ctz((uint32_t)(value)) : (32 +
                                                                                         __builtin_ctz(
                                                                                                 (uint32_t)(
                                                                                                         value
                                                                                                                 >> 32)));
