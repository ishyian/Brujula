...
BASELIB_API Baselib_Timer_TickToNanosecondConversionRatio

Baselib_Timer_GetTicksToNanosecondsConversionRatio(void);
...
BASELIB_API Baselib_Timer_Ticks

Baselib_Timer_GetHighPrecisionTimerTicks(void);
