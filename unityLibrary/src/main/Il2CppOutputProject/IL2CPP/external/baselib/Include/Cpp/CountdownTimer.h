...
namespace baselib {
    ...
    public:
        ...
        high_precision_clock::duration GetTimeLeft() const {
            return high_precision_clock::duration_from_ticks(
                    Baselib_CountdownTimer_GetTimeLeftInTicks(m_CountdownTimer));
        }
    ...
    private:
        ...
        CountdownTimer(const high_precision_clock::duration timeout) : m_CountdownTimer(
                Baselib_CountdownTimer_StartTicks(
                        high_precision_clock::ticks_from_duration_roundup(timeout))) {}
