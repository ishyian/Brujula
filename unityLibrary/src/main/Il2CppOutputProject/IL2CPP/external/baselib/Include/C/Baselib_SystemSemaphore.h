...
typedef struct Baselib_SystemSemaphore_Handle {
    void *handle;
} Baselib_SystemSemaphore_Handle;

// This is the maximum number of tokens that can be made available on a semaphore
enum {
    Baselib_SystemSemaphore_MaxCount = INT32_MAX
};
...
BASELIB_API Baselib_SystemSemaphore_Handle

Baselib_SystemSemaphore_Create(void);
...
Baselib_SystemSemaphore_CreateInplace(void *semaphoreData);
...
BASELIB_API bool Baselib_SystemSemaphore_TryTimedAcquire(Baselib_SystemSemaphore_Handle semaphore,
...
BASELIB_API void
Baselib_SystemSemaphore_Release(Baselib_SystemSemaphore_Handle semaphore, uint32_t count);
