...
// Event queue handle.
typedef struct Baselib_FileIO_EventQueue {
    void *handle;
} Baselib_FileIO_EventQueue;

// Async file handle.
typedef struct Baselib_FileIO_AsyncFile {
    void *handle;
} Baselib_FileIO_AsyncFile;

// Sync file handle.
typedef struct Baselib_FileIO_SyncFile {
    void *handle;
} Baselib_FileIO_SyncFile;
...
typedef void (*EventQueueCallback)(uint64_t
userdata);
...
//
// \returns Event queue.
BASELIB_API Baselib_FileIO_EventQueue

Baselib_FileIO_EventQueue_Create(void);
...
BASELIB_API uint64_t
Baselib_FileIO_EventQueue_Dequeue(
        Baselib_FileIO_EventQueue
eq,
...
BASELIB_API Baselib_FileIO_AsyncFile
Baselib_FileIO_AsyncOpen(
        Baselib_FileIO_EventQueue
eq,
const char *pathname,
        uint64_t
...
BASELIB_API Baselib_FileIO_SyncFile
...
// \returns File size.
BASELIB_API uint64_t
Baselib_FileIO_SyncGetFileSize(
        Baselib_FileIO_SyncFile
file,
Baselib_ErrorState *errorState
);
