...
BASELIB_API Baselib_Thread_Id

Baselib_Thread_GetCurrentThreadId(void);
...
BASELIB_API Baselib_Thread
*
Baselib_Thread_Create(Baselib_Thread_Config
config,
...
BASELIB_API void Baselib_Thread_Join(Baselib_Thread * thread, uint32_t
...
// \param thread        A pointer to a thread object.
BASELIB_API Baselib_Thread_Id
Baselib_Thread_GetId(Baselib_Thread
* thread);
