...
AO_test_and_set(volatile AO_TS_t *addr) {
    return (AO_TS_VAL_t)
    __atomic_test_and_set(addr, __ATOMIC_RELAXED);
}
...
AO_test_and_set_acquire(volatile AO_TS_t *addr) {
    return (AO_TS_VAL_t)
    __atomic_test_and_set(addr, __ATOMIC_ACQUIRE);
}
...
AO_test_and_set_release(volatile AO_TS_t *addr) {
    return (AO_TS_VAL_t)
    __atomic_test_and_set(addr, __ATOMIC_RELEASE);
}
...
AO_test_and_set_full(volatile AO_TS_t *addr) {
    return (AO_TS_VAL_t)
    __atomic_test_and_set(addr, __ATOMIC_SEQ_CST);
}
