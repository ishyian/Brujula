...
GC_API void GC_CALL
GC_set_push_other_roots(GC_push_other_roots_proc
fn)
{
...
GC_CALL GC_get_push_other_roots(void) {
...
GC_API void GC_CALL
GC_set_mark_stack_empty (GC_mark_stack_empty_proc
fn)
{
GC_on_mark_stack_empty = fn;
}

GC_API GC_mark_stack_empty_proc

GC_CALL GC_get_mark_stack_empty(void) {
