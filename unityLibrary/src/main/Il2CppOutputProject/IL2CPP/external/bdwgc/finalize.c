...
GC_general_register_disappearing_link(void **link,
                                      const void *obj) {
...
STATIC GC_toggleref_func
GC_toggleref_callback = 0;
STATIC GCToggleRef
*
GC_toggleref_arr = NULL;
...
GC_API void GC_CALL
GC_set_toggleref_func(GC_toggleref_func
fn)
{
DCL_LOCK_STATE;
...
GC_API GC_toggleref_func

GC_CALL GC_get_toggleref_func(void) {
...
STATIC GC_await_finalize_proc
GC_object_finalized_proc = 0;

GC_API void GC_CALL
GC_set_await_finalize_proc(GC_await_finalize_proc
fn)
{
DCL_LOCK_STATE;
...
GC_CALL GC_get_await_finalize_proc(void) {
...
GC_register_finalizer(void *obj,
                      GC_finalization_proc fn, void *cd,
                      GC_finalization_proc *ofn, void **ocd) {
...
GC_register_finalizer_ignore_self(void *obj,
                                  GC_finalization_proc fn, void *cd,
                                  GC_finalization_proc *ofn, void **ocd) {
    GC_register_finalizer_inner(obj, fn, cd, ofn,
...
GC_register_finalizer_no_order(void *obj,
                               GC_finalization_proc fn, void *cd,
                               GC_finalization_proc *ofn, void **ocd) {
    GC_register_finalizer_inner(obj, fn, cd, ofn,
...
GC_register_finalizer_unreachable(void *obj,
                                  GC_finalization_proc fn, void *cd,
                                  GC_finalization_proc *ofn, void **ocd) {
...
#ifndef SMALL_CONFIG
STATIC word
GC_old_dl_entries = 0; /* for stats printing */
# ifndef GC_LONG_REFS_NOT_NEEDED
STATIC word
GC_old_ll_entries = 0;
# endif
        ...
        while (curr_fo != 0) {
            ...
            if (!GC_is_marked(real_ptr)) {
                ...
                curr_fo->fo_hidden_base =
                        (word)
                GC_REVEAL_POINTER(curr_fo->fo_hidden_base);
                GC_bytes_finalized +=
