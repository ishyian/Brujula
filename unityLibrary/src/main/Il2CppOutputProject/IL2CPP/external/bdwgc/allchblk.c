        ...
        if (size_avail != size_needed) {
            ...
            if (thishbp != 0) {
                ...
                if (next_size < size_avail
                    ...
                    && !GC_is_black_listed(thishbp, (word)
                    size_needed)) {
                    continue;
                }
            }
